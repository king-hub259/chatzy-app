              ...
              onPressed: () async {
                ...
                if (groupTitleCtrl.textDescController.text !=
                  ...
                  await FirebaseFirestore.instance
                      ...
                      .doc(groupTitleCtrl.pId)
                      .update({
                    "desc": groupTitleCtrl.textDescController.text
                  }).then((value) {
                    groupTitleCtrl.allData["desc"] =
                  ...
                  SizedBox(
                    ...
                    child: groupTitleCtrl.groupImage == null || groupTitleCtrl.groupImage == ""
                        ? DottedBorder(
                                ...
                                color:
                                    appCtrl.appTheme.greyText.withOpacity(0.6),
                                radius: const Radius.circular(AppRadius.r50),
                                child: ClipRRect(
                                    borderRadius: const BorderRadius.all(
                                        Radius.circular(AppRadius.r5)),
                                    child: SizedBox(
                                            child: Icon(CupertinoIcons.add, size: Sizes.s20, color: appCtrl.appTheme.greyText.withOpacity(0.6))
