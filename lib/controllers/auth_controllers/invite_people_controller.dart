...
class InvitePeopleController extends GetxController {
  ...
  onInvitePeople({number}) async {
    try {
      Share.share(
          "Let's chat on Chatzy ! It's a fast, simple, and secure app we can use to message and call our friends for free.https://play.google.com/store/apps/details?id=com.webiots.chatzy");
    } catch (e) {
