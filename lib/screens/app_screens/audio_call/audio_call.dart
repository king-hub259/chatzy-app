                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                          ...
                                          Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                    color: appCtrl
                                                        .appTheme.primary),
                                                image: audioCallCtrl.call!.callerId ==
                                                        appCtrl.user['id']
                                                    ? audioCallCtrl.call!.receiverPic != null &&
                                                            audioCallCtrl.call!
                                                                    .receiverPic !=
                                                                ""
                                                        ? DecorationImage(
                                                    ...
                                                    : audioCallCtrl.call!.callerPic !=
                                                        ...
                                                        ? DecorationImage(
                                                            fit: BoxFit.cover,
                                                            image: NetworkImage(audioCallCtrl.call!.callerPic!))
                                                        : DecorationImage(fit: BoxFit.cover, image: AssetImage(eImageAssets.anonymous)),
                                              ))
                                        ],
                                    ...
                                    Text(
                                        "${audioCallCtrl.userData["id"] == audioCallCtrl.call!.callerId ? audioCallCtrl.call!.receiverName : audioCallCtrl.call!.callerName} Audio Call",
                                                              ...
                                                              : snapshot.data!.data()!["status"] ==
                                                                  ...
                                                                  : snapshot.data!.data()!["status"] ==
                                                                      ...
                                                                      : snapshot.data!.data()!["status"] == 'rejected'
                                                                          ...
                                                                          : appFonts.plsWait.tr,
                                              style: AppCss.manropeblack14.textColor(appCtrl.appTheme.primary))
                                  ],
                                ).marginOnly(
                                    left: Insets.i45,
                                  ...
                                  onTap: () async {
                                    if (snapshot.hasData) {
                                      if (snapshot.data!.data() != null ||
                                          snapshot.data != null) {
                                        audioCallCtrl.isAlreadyEnded = snapshot
                                                        .data!
                                                        .data()!["status"] ==
                                                    'ended' ||
                                                snapshot.data!
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Positioned(
          right: (MediaQuery.of(context).size.width / 2.9) + offset.dx,
