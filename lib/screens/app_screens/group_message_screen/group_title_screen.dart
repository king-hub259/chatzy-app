...
class GroupTitleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<GroupMessageController>(builder: (_) {
        ...
        child: Scaffold(
          ...
          body: Stack(
            children: [
                          ...
                          children: [
                                  ...
                                  ? Stack(
                                      ...
                                      children: [
                                        SizedBox(
                                          width: Sizes.s80,
                                          height: Sizes.s80,
                                          child: groupTitleCtrl.pickerCtrl.image == null
                                              ? DottedBorder(
                                                      borderType:
                                                          BorderType.RRect,
                                                      color: appCtrl
                                                      ...
                                                      child: ClipRRect(
                                                          ...
                                                          child: SizedBox(child: Icon(CupertinoIcons.add, size: Sizes.s20, color: appCtrl.appTheme.greyText.withOpacity(0.6)).paddingAll(Insets.i3).decorated(borderRadius: BorderRadius.circular(AppRadius.r8), border: Border.all(color: appCtrl.appTheme.greyText.withOpacity(0.6)))).alignment(Alignment.center)))
                                                  .paddingAll(Insets.i4)
                                                  .inkWell(onTap: () => groupTitleCtrl.pickerCtrl.imagePickerOption(context, isCreateGroup: true))
                                              : ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(AppRadius.r50)), child: Image.file(groupTitleCtrl.pickerCtrl.image!, fit: BoxFit.fill).inkWell(onTap: () => groupTitleCtrl.pickerCtrl.onTapGroupProfile(isCreateGroup: true, context))).paddingAll(Insets.i4).decorated(color: appCtrl.appTheme.white, shape: BoxShape.circle),
                                        ).decorated(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFieldCommon(
                                  hintText: groupTitleCtrl.isGroup
                                      ? appFonts.addGroupTitle
                                      : appFonts.addBroadcastTitle,
                                ...
                                Text(
                                    appFonts.participant.tr +
                                        groupTitleCtrl.selectedContact.length
                                            .toString(),
                                    style: AppCss.manropeMedium15
                                        .textColor(appCtrl.appTheme.greyText)),
                                ...
                                GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Column(children: [
                                        CachedNetworkImage(
                                            imageUrl: groupTitleCtrl
                                                .selectedContact[index]["image"]
                                                .toString(),
                                            imageBuilder:
              ...
              if (groupTitleCtrl.isLoading) const CommonLoader()
            ],
          ),
        ),
      );
