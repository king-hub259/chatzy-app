                        ...
                        children: <Widget>[
                          ...
                          if (widget.document!.type == MessageType.text.name||widget.document!.type == MessageType.emoji.name )
                            GroupReceiverContent(
                                ...
                                onLongPress: () =>
                                    chatCtrl.onLongPressFunction(widget.docId, widget.title, widget.document!),
                            ...
                            (decryptMessage(widget.document!.content).contains(".pdf"))
                              ...
                              // document: widget.document,
                                ...
                                onLongPress: () => chatCtrl
                                    .onLongPressFunction(widget.docId, widget.title, widget.document!),
                                onTap: () => GroupOnTapFunctionCall()
                              ...
                              //  document: widget.document,
                                ...
                                isReceiver: true,
                                document: widget.document,
                                onLongPress: () => chatCtrl.onLongPressFunction(widget.docId, widget.title, widget.document!),
