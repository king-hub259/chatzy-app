                                                    ...
                                                    Column(
                                                        crossAxisAlignment:
                                                            CrossAxisAlignment
                                                                .start,
                                                        children: [
                                                          // do the admin color primary
                                                          Text(
                                                              snapshot.data!.data()!["id"] == (FirebaseAuth.instance.currentUser != null ? FirebaseAuth.instance.currentUser!.uid : chatCtrl.user["id"])
                                                                  ? "Me"
                                                      ...
                                                      //                 .darkText)),
                                                          ...
                                                          Text(
                                                              ...
                                                              style: AppCss
                                                                  ...
                                                                  .textColor(appCtrl
                                                                      .appTheme
                                                                      .greyText)).width(Sizes.s180)
                                                        ]),

                                                           ]).marginOnly(bottom: Insets.i15),
                                                  if(snapshot.data!.data()!["id"] == chatCtrl.allData["createdBy"]["id"])
                                                    Text("Admin", style: AppCss
                                                        .manropeSemiBold14
