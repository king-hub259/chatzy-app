        ...
        child: GetBuilder<AppController>(builder: (appCtrl) {
          return Scaffold(
              ...
              floatingActionButton: groupChatCtrl.selectedContact.isNotEmpty
                  ...
                  : Container(),
              body: Stack(children: [
                SingleChildScrollView(child: Consumer<ContactProvider>(
                  ...
                  return Stack(children: [
                    SingleChildScrollView(
                        child: Column(
                          ...
                          if (registerAvailableContact
                              .registeredContacts.isNotEmpty)
                            Column(children: [
                              ...registerAvailableContact.registeredContacts
                                  .asMap()
                                  .entries
                                  .map((e) {
