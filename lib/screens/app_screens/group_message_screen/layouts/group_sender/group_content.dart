...
class GroupContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var data = Get.put(GroupChatMessageController());
    // log("Hello log reply original sender name :: ${document} /// ${document!.sender} ////${document!.replyTo} ///${document!.originalSenderName}");
          ...
          InkWell(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    //       document!.replyTo != "")
                    //     ReplySenderLayout(document: document,isGroup: true,),
                        ...
                        ? Column(children: [
                            if (document!.sender == appCtrl.user['id'])
                              if (document!.replyTo != null &&
                                  document!.replyTo != "")
                                ReplySenderLayout(
                                    document: document, isGroup: true),
                            Container(
