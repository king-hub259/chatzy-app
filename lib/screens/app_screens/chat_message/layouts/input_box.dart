...
import 'package:chatzy/screens/app_screens/chat_message/layouts/reply_to.dart';
              ...
              children: [
                if (isReplying)
                  ReplyTo(
                    ...
                    messageModel: chatCtrl.replyMessage,
                    audioDuration: chatCtrl.audioDuration,
                    videoDuration: chatCtrl.videoDuration,
                  ),
                Container(
