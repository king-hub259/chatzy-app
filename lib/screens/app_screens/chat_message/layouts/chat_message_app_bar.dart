          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: AppBar(
                  ...
                  titleSpacing: 0,
                  leading: SvgPicture.asset(appCtrl.isRTL || appCtrl.languageVal == "ar" ? eSvgAssets.arrowRight : eSvgAssets.arrowLeft,
                    ...
                    chatCtrl.isChatSearch == true
                        ...
                        : chatCtrl.selectedIndexId.isNotEmpty
                            ? Row(children: [
                                ...
                                /*chatCtrl.selectedIndexId.length > 1
                                    ? Container()
                                    : SvgPicture.asset(eSvgAssets.reply,
                                            colorFilter: ColorFilter.mode(
                                                appCtrl.appTheme.sameWhite,
                                                BlendMode.srcIn),
                                            height: Sizes.s18,
                                        ...
                                        child: PopupMenuButton(
                                                ...
                                                onSelected: (result) async {
                                                  ...
                                                  if (result == 1) {
                                                    ...
                                                    log("chat id backgroundList ${chatCtrl.chatId}");
                                                    chatCtrl.isFilter = false;
                                                    Get.toNamed(
                                                        routeName.backgroundList,
                                                        arguments: {"chatId": chatCtrl.chatId}
                                                    )!.then((value) {
                                                      if (value != null) {
                                                        chatCtrl.selectedWallpaper = value;

                                                        /// Save wallpaper per chatId
                                                        appCtrl.storage.write("backgroundImage_${chatCtrl.chatId}", value);

                                                        chatCtrl.update();
                                                        log("chatCtrl.selectedImage : ${chatCtrl.selectedWallpaper}");
                                                        Get.forceAppUpdate();
                                                        chatCtrl.loadChatWallpaper(chatCtrl.chatId!);
                                                      }

                                                    });
                                                  }
                                                  /*else if (result == 2) {
                                                    log ("chat id ${chatCtrl.chatId}");
                                                    chatCtrl.isFilter = false;
                                                    Get.toNamed(
                                                            routeName
                                                                .backgroundList,
