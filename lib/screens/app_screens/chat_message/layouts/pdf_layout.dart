    ...
    return Stack(
      ...
      children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              if (widget.document!.sender == appCtrl.user['id'])
                if (widget.document!.replyTo != null &&
                  ...
                  ReplySenderLayout(document: widget.document,isGroup: widget.isGroup,),
              Row(
                children: [
                  ...
                  ).decorated(color: appCtrl.appTheme.primary, borderRadius: SmoothBorderRadius.only(
        ...
        if (widget.document!.emojiList != null &&
          ...
          Row(children: [
            ...widget.document!.emojiList!.asMap().entries.map((e) => Align(
                widthFactor: 0.5,
                child: EmojiLayout(
                    emoji: e.value['emoji'], onTap: widget.emojiTap)))
          ])
      ],
    );
  }
