...
import '../../../config.dart';
import '../../../controllers/bottom_controllers/profile_screen_controller.dart';
                          ...
                          Stack(alignment: Alignment.bottomRight, children: [
                            SizedBox(
                                ...
                                appCtrl.user["image"] != null &&
                                    ...
                                    child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(AppRadius.r5)), child: SizedBox(child: Icon(CupertinoIcons.add, color: appCtrl.appTheme.greyText.withOpacity(0.6)).paddingAll(Insets.i4).decorated(borderRadius: BorderRadius.circular(AppRadius.r8), border: Border.all(color: appCtrl.appTheme.greyText.withOpacity(0.6)))).alignment(Alignment.center)))
