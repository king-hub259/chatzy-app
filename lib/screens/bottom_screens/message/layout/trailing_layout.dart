                  ...
                  if (snapshot.hasData) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        appCtrl.user["id"] != document!["senderId"]?
                          number == 0
                              ? (document!.data() as Map<String,dynamic>).containsKey('isPin') && document!["isPin"] == true? SvgPicture.asset(eSvgAssets.pinFill).marginOnly(top: 12) :Container()
                              : Container(
                              height: Sizes.s20,
